...
// TODO: This code should not see the light of day if we choose to compile it in (gpl mode?)
...
public:
    ...
    ~HWContext() {
        av_buffer_unref(&avCtx);
    }
};

// TODO: Only construct these in case we end up using the associated Encoding Pipeline
class VkFrameCtx
{
public:
